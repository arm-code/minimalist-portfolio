  ...
  return (
    <div className='flex flex-col items-center gap-12 py-12 px-6 min-h-svh text-slate-800' id='aboutPage'>
      <div className="text-center space-y-2 pt-8 md:pt-0">
        <h1 className="text-4xl md:text-6xl font-black uppercase text-violet-900">About Me</h1>
        <p className="text-violet-600 font-semibold text-base md:text-lg tracking-wide">What do I do?</p>
      </div>

      <div className='flex flex-col lg:flex-row gap-10 lg:gap-16 items-center max-w-6xl w-full '>
        <div className='flex-1 space-y-4 md:space-y-6 text-base md:text-lg text-slate-600 leading-relaxed order-2 lg:order-1'>
        ...
        <div className='relative group order-1 lg:order-2'>
          ...
          <img
            src={arm}
            alt='Alexis Romero'
            className='relative w-64 md:w-80 h-auto object-cover rounded-3xl shadow-2xl shadow-violet-500/20 transition-transform duration-500 group-hover:scale-[1.02] '
          />
        </div>

        <div className='flex-1 space-y-4 md:space-y-6 text-base md:text-lg text-slate-600 leading-relaxed order-3'>
          <p className='text-violet-600'>
      ...
      <div className='flex flex-wrap justify-center gap-6 md:gap-10 text-4xl md:text-6xl text-violet-400 pt-8 md:pt-12'>
